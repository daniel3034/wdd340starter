...
-- Clean up existing review table if it exists
...
CREATE TABLE IF NOT EXISTS public.review (
  ...
  CONSTRAINT fk_review_account FOREIGN KEY (account_id) REFERENCES public.account (account_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT fk_review_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT unique_user_vehicle_review UNIQUE (account_id, inv_id)
);
